...
public class WhiteGoodApplianceControlFactory implements ClusterFunctionFactory {
	...
	public ServiceRegistration createFunctionService(IAppliance appliance, Integer endPointId, IAppliancesProxy appliancesProxy) {
		...
		case 37: // It's a Washing machine
			d.put(Function.SERVICE_OPERATION_NAMES, new String[] { "execStartCycle", "execStopCycle", "execPauseCycle",
					"execOverloadPauseResume", "execOverloadPause", "execOverloadWarning" });
			d.put(Function.SERVICE_PROPERTY_NAMES, new String[] { WashingMachine.PROPERTY_CYCLE,
					WashingMachine.PROPERTY_TEMPERATURE, WashingMachine.PROPERTY_SPIN, WashingMachine.PROPERTY_STARTTIME,
					WashingMachine.PROPERTY_FINISHTIME, WashingMachine.PROPERTY_REMAININGTIME,
		...
		case 38: // It's the oven
			d.put(Function.SERVICE_OPERATION_NAMES, new String[] { "execStartCycle", "execStopCycle", "execOverloadPauseResume",
					"execOverloadPause" });
			d.put(Function.SERVICE_PROPERTY_NAMES, new String[] { Oven.PROPERTY_CYCLE, Oven.PROPERTY_TEMPERATURE,
					Oven.PROPERTY_STARTTIME, Oven.PROPERTY_FINISHTIME, Oven.PROPERTY_REMAININGTIME, Oven.PROPERTY_REMOTECONTROL });
		...
		case 39: // It's the Fridge
			...
			d.put(Function.SERVICE_PROPERTY_NAMES, new String[] { Fridge.PROPERTY_FRIDGETEMPERATURE,
					Fridge.PROPERTY_FREEZERTEMPERATURE, Fridge.PROPERTY_ECOMODE, Fridge.PROPERTY_HOLIDAYMODE,
					Fridge.PROPERTY_ICEPARTY, Fridge.PROPERTY_SUPERCOOLMODE, Fridge.PROPERTY_SUPERFREEZE });
